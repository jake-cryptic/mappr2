...
def create_app():
	...
	def apply_headers(response):
		...
		if not request.path.startswith('/static/') and not request.path.startswith('/api/'):
			...
			csp_header_value = "script-src 'self' 'unsafe-inline' https://analytics.mappr.uk https://static.cloudflareinsights.com https://fonts.googleapis.com https://cdnjs.cloudflare.com https://unpkg.com https://api-maps.yandex.ru https://yastatic.net https://*.maps.yandex.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://unpkg.com; img-src 'self' data: https://cdnjs.cloudflare.com https://api.cellmapper.net https://www.three.co.uk/ https://mapserver.vodafone.co.uk https://68aa7b45-tiles.spatialbuzz.net https://coverage.ee.co.uk https://mt1.google.com https://tile.opentopomap.org https://*.tile.openstreetmap.org https://api-maps.yandex.ru https://*.maps.yandex.net https://*.api.tomtom.com; font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com; connect-src 'self' https://analytics.mappr.uk https://nominatim.openstreetmap.org https://mappr.report-uri.com; media-src 'none'; object-src 'none'; child-src 'none'; form-action 'self'; upgrade-insecure-requests; block-all-mixed-content; manifest-src 'self'; report-uri https://mappr.report-uri.com/r/d/csp/reportOnly"
